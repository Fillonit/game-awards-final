...
<body>
    ...
    <body>
        ...
        <body>
            ...
            <p>These Website Standard Terms of Service (these “Terms” or these “Website Standard Terms of Service”)
                ...
                conditions contained herein in full. If you disagree with these Terms or any part of these Terms, you
            ...
            <p>You may view, download for caching purposes only, and print pages from the website for your own personal
                use, subject to the restrictions set out below and elsewhere in these Terms of Service.</p>

            <h2>4. Acceptable Use</h2>
            <p>You must not use this Website in any way that causes, or may cause, damage to the Website or impairment
                ...
                activity.</p>
            <ul>
                <li>You must not conduct any systematic or automated data collection activities (including without
                    limitation scraping, data mining, data extraction and data harvesting) on or in relation to this
                    Website without our express written consent.</li>
                <li>You must not use this Website to transmit or send unsolicited commercial communications.</li>
                <li>You must not use this Website for any purposes related to marketing without our express written
                    consent.</li>
            </ul>

            <h2>5. Limitations of Liability</h2>
            <p>We will not be liable to you (whether under the law of contract, the law of torts or otherwise) in
                relation to the contents of, or use of, or otherwise in connection with, this Website for any direct,
                indirect or consequential loss; or for any business losses, loss of revenue, income, profits or
            ...
            <footer>
                <div class="footer-container">
                    <p>&copy; <?php echo date('Y'); ?> MyWebsite</p>
                    <nav>
                        <ul>
                            <li><a href="#">Terms of Use</a></li>
                            <li><a href="#">Privacy Policy</a></li>
                            <li><a href="#">Contact Us</a></li>
                            <li><a href="https://github.com/myusername"><i class="fab fa-github"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/myusername/"><i class="fab fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
